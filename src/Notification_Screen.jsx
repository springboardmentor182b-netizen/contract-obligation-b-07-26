...
export default function Notification_Screen() {const [dashboard, setDashboard] = useState({
    stats: {
        total: 0,
        unread: 0,
        email: 0,
...
<div className="d-flex justify-content-between align-items-center mt-5 mb-4">
    ...
    <div>
        ...
        <p>Total Notifications from Backend: {dashboard.feed.length}</p>
    ...
    <div className="col-lg-3">
        <div className="notification-card">
            ...
            <div className="d-flex justify-content-between">
                ...
                <div>
                    <p>UNREAD</p><h1>{dashboard.stats.unread}</h1>
...
<div className="row mt-4">
    ...
    <div
        key={item.id}
        className={`feed-item ${item.type.toLowerCase()}`}
    >
        <div>
            <h6>{item.title}</h6>
