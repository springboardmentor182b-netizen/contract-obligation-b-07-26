...
export default function Sidebar({
  ...
  return React.createElement(
    ...
    React.createElement('div', { className: 'brand' },
      React.createElement('span', { className: 'brand-mark' }, React.createElement(Icon, { name: 'file' })),
      React.createElement('span', { className: 'brand-name' }, 'ContractIQ'),
    ),
    React.createElement('nav', { className: 'sidebar-nav', 'aria-label': 'Main navigation' },
      navigationItems.map(([label, icon, path, countKey]) => React.createElement(
        ...
        countKey && counts[countKey] ? React.createElement('span', { className: 'nav-count' }, counts[countKey]) : null,
      )),
    ),
