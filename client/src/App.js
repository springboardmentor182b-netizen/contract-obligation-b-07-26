...
const REMINDER_TEMPLATES = [{
  id: "RT-001",
  name: "90-Day Advance Notice",
  trigger: "90 days before expiry",
  channels: ["Email", "In-App"],
  frequency: "Once",
  recipients: "Contract Owner",
  active: true,
  lastSent: "Mar 15, 2024"
}, {
  id: "RT-002",
  name: "30-Day Critical Alert",
  ...
  active: true,
  lastSent: "May 24, 2024"
}, {
  id: "RT-004",
  name: "Day-Of Expiry Alert",
  trigger: "Day of expiry",
  channels: ["Email", "SMS", "In-App"],
  frequency: "Once",
  recipients: "All Stakeholders",
  active: true,
  lastSent: "May 31, 2024"
}, {
  id: "RT-005",
  name: "Post-Expiry Follow-Up",
  trigger: "3 days after expiry",
  channels: ["Email", "In-App"],
  frequency: "Once",
  recipients: "Contract Owner + Admin",
  active: false,
  lastSent: "Apr 12, 2024"
}];
const APPROVAL_STEPS = [{
  id: 1,
  step: "Renewal Request Created",
  role: "Contract Owner",
  person: "Lisa Torres",
  initials: "LT",
  date: "May 20, 2024",
  status: "completed",
  comments: "Renewal submitted for Commercial Lease — HQ Tower A. Proposed 2-year extension at current rate with 3% annual escalation."
}, {
  id: 2,
  step: "Legal Review",
  role: "Legal Manager",
  ...
  date: "May 22, 2024",
  status: "completed",
  comments: "Legal terms reviewed and approved. Minor amendment to termination clause — updated to 90-day notice from 60-day."
}, {
  id: 3,
  ...
  date: "May 25, 2024",
  status: "completed",
  comments: "GDPR and insurance compliance verified. All documentation is current and complete."
}, {
  id: 4,
  ...
  date: "May 28, 2024",
  status: "current",
  comments: "Awaiting department budget confirmation for FY2025 allocation."
}, {
  id: 5,
  step: "Executive Approval",
  role: "C-Suite Executive",
  person: "Jennifer Walsh — CFO",
  initials: "JW",
  date: "Pending",
  status: "pending",
  comments: ""
  ...
  id: 6,
  step: "Renewal Completed",
  role: "System",
  person: "ContractIQ Platform",
  initials: "CQ",
  date: "Pending",
  status: "pending",
  comments: ""
...
const RENEWAL_HISTORY = [{
  id: "RH-001",
  contractName: "Commercial Lease — HQ Tower A",
  version: "v4.0",
  renewalDate: "Jun 1, 2022",
  duration: "2 years",
  approvedBy: "Michael Grant",
  status: "Renewed",
  notes: "Extended at current rate, added 3% annual escalation clause. Floor 16 added to lease scope."
}, {
  id: "RH-002",
  contractName: "APAC Distribution Agreement",
  version: "v2.1",
  renewalDate: "Jul 1, 2023",
  duration: "1 year",
  approvedBy: "Sarah Chen",
  status: "Renewed",
  notes: "Rate renegotiated — 5% reduction on volume commitments above $500K."
}, {
  id: "RH-003",
  contractName: "Enterprise SaaS License — Salesforce CRM",
  version: "v3.0",
  renewalDate: "Jan 1, 2024",
  duration: "1 year",
  approvedBy: "Mark Johnson",
  status: "Renewed",
  notes: "Added Sales Cloud Enterprise module. Pricing held flat from prior term."
}, {
  id: "RH-004",
  contractName: "Marketing Agency Retainer Agreement",
  version: "v1.5",
  renewalDate: "Jan 1, 2024",
  duration: "1 year",
  approvedBy: "Sarah Chen",
  status: "Renewed",
  notes: "Scope extended to include digital performance marketing. Budget increased 12%."
}, {
  id: "RH-005",
  contractName: "Cloud Infrastructure Agreement — AWS",
  version: "v2.0",
  renewalDate: "Mar 1, 2024",
  duration: "2 years",
  approvedBy: "Michael Grant",
  status: "Renewed",
  notes: "Committed $480K/yr spend for reserved instance pricing — 22% savings vs on-demand."
}, {
  id: "RH-006",
  contractName: "Legal Advisory Consulting Agreement",
  version: "v1.0",
  renewalDate: "Feb 15, 2023",
  duration: "1 year",
  approvedBy: "Lisa Torres",
  status: "Expired",
  notes: "Original term completed. Not renewed — work transferred to in-house counsel."
}];
