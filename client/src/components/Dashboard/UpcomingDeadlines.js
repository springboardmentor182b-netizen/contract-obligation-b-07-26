...
export default function UpcomingDeadlines({ deadlines = [], compact = false, onExport }) {
  if (compact) {
  ...
  return React.createElement('section', { className: 'dashboard-card deadlines-card' },
    React.createElement('div', { className: 'card-heading deadlines-heading' }, React.createElement('div', null, React.createElement('h2', null, 'Upcoming Deadlines'), React.createElement('p', null, 'Next 90 days')), React.createElement('button', { className: 'secondary-button', type: 'button', onClick: onExport }, 'Export')),
